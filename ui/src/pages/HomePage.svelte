...
<main class="w-screen h-screen bg-[url('/kinoji.jpg')] max-sm:bg-[url('/kinoji_mob.png')] bg-cover bg-center bg-no-repeat flex items-center justify-center relative overflow-hidden font-['Funnel_Display',sans-serif]">
  <!-- Kinoji Logo -->
  <h1 class="absolute top-6 left-1/2 -translate-x-1/2 text-2xl font-medium text-white z-20">Kinoji</h1>

  <!-- Social Links -->
  <div class="absolute top-6 right-6 max-sm:top-4 max-sm:right-4 flex items-center gap-4 z-20">
    <a href="https://www.kaggle.com/datasets/vedantthanekar45/dataset-for-movies-from-1920-to-2025-size-59k" target="_blank" rel="noreferrer" class="text-white hover:text-white/80 transition-all duration-300 ease-in-out hover:scale-110" aria-label="View dataset on Kaggle">
    ...
    <a href="https://github.com/vedanthanekar45/kinoji" target="_blank" rel="noreferrer" class="text-white hover:text-white/80 transition-all duration-300 ease-in-out hover:scale-110" aria-label="Visit GitHub repository">
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
